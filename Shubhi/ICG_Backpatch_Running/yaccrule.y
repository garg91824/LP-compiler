...
%type<mark> marker
%type<List> statement Next selection_statement compound_statement iteration_statement  statement_list 
...
;
statement_list:
  statement_list marker statement{ backpatch($1.nextList,$2.instr); $$.nextList = $3.nextList;}
...
statement:
  ...
  |compound_statement{$$.nextList = $1.nextList;}
  |selection_statement{$$.nextList = $1.nextList;}
  |iteration_statement{$$.nextList = $1.nextList;}
;

declaration:
    var_type ID SEMICOLON{}
  | var_type ID ASSIGN Exp SEMICOLON {gencode($2.addr,$4.addr);}
;
var_type:
  INT {}
  |FLOAT {}
...
;
case_list:
  CASE constant    COLON compound_statement{ }
  |case_list CASE constant    COLON compound_statement{ }
;
...
|SWITCH LP Exp RP marker LB switch_statement RB{}
;
