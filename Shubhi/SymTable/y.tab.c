...
#line 41 "sym.y" /* yacc.c:1646  */
    {sprintf(temp,"%d",(yyvsp[0].char*)); insert(2);}
...
#line 44 "sym.y" /* yacc.c:1646  */
    {sprintf(temp,"%d",(yyvsp[0].char*)); insert(3);}
